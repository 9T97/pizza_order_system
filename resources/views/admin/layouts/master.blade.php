                                        ...
                                        <div class="image">
                                            ...
                                            @if (Auth::user()->image == null)
                                                @if (Auth::user()->gender == 'male')
                                                    <img src="{{ asset('image/MaleLogo.png') }}" alt="{{ Auth::user()->name }}" class=" img-thumbnail shadow-sm"/>
                                                @else
                                                    <img src="{{ asset('image/FemaleLogo.png') }}" alt="{{ Auth::user()->name }}" class=" img-thumbnail shadow-sm"/>
                                                @endif
                                            @else
