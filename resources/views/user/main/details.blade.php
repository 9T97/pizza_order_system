            ...
            <div class="h-100 bg-light p-30">
                ...
                <div class="d-flex align-items-center mb-4 pt-2">
                    <div class="input-group quantity mr-3" style="width: 130px;">
                        ...
                        <input type="text" class="form-control bg-info border-0 text-center" value="1" min="1" max="20" id="orderCount">
                        <div class="input-group-btn">
                    ...
                    <button type="button" class="btn btn-outline-primary px-3 " id="addCartBtn"><i class="fa fa-shopping-cart mr-1 "></i> Add To
                        Cart</button>
                </div>
                    ...
                    <div class="product-item bg-light">
                        <div class="product-img position-relative overflow-hidden">
                            ...
                            <div class="product-action">
                                ...
                                <a class="btn btn-outline-dark btn-square" href="{{ route('user#pizzaDetails',$pl->id) }}"><i class="fa-solid fa-circle-info"></i></a>
                            </div>
                        </div>
                        <div class="text-center py-4">
                            ...
                            <div class="d-flex align-items-center justify-content-center mb-1">
                                ...
                                <small class="fa fa-star text-primary mr-1"></small>
                                <small class="fa fa-star text-primary mr-1"></small> --}}
                                <small>{{ $pl->view_count }} <i class="fa-solid fa-eye"></i></small>
                            </div>
                        </div>
                    </div>
                @endforeach
